...
//    private static String signature(MacRetailSignature macRetail, String macKey,
//                                    String xAmzDate) throws UnsupportedEncodingException, Exception {
...
//        byte[] signatureKey = Hex.decodeHex(macKey.toCharArray());
//
//        //TODO: Reemplazar por la firma del dispositivo
//        byte[] signature = macRetail.macRetail(signatureKey, Hex.encodeHexString(stringToSign.getBytes("UTF-8")));
//
