...
import com.pax.tradepaypw.EEmvExceptions;
import com.pax.tradepaypw.EmvTestAID;
import com.pax.tradepaypw.EmvTestCAPK;
import com.pax.tradepaypw.GetPinEmv;
import com.pax.tradepaypw.abl.core.AAction;
import com.pax.tradepaypw.abl.core.ActionResult;
...
public class ImplEmv {
    ...
    public int startContactEmvTrans() {
        ...
        //emvParam.countryCode = Utils.str2Bcd("0840");// dolares
        emvParam.countryCode = Utils.str2Bcd("0604"); //soles
        ...
        emvParam.merchCateCode = Utils.str2Bcd("0604");
        //emvParam.referCurrCode = Utils.str2Bcd("0840");
        emvParam.referCurrCode = Utils.str2Bcd("0604");
    ...
    public void enterPin(boolean isOnlinePin, int offlinePinLeftTimes) {
        ...
        actionEnterPin.setEndListener(new AAction.ActionEndListener() {
            ...
            public void onEnd(AAction action, ActionResult result) {
                ...
                ConsumeOtcActivity.getInstance().onStop();
