...
import com.pax.tradepaypw.ImplEmv;
...
public class ConsumeOtcActivity extends AppCompatActivity {

    private static final String TAG = "ConsumeOtcActivity";
    ...
    private static ConsumeOtcActivity instance;

    public static ConsumeOtcActivity getInstance() {
        if (instance == null) {
            instance = new ConsumeOtcActivity();
        }
        return instance;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consume_otc);
...
//    }
    ...
    private void initInputPwdDialog() {
        ...
        dialog.setPwdListener(new InputPwdDialog.OnPwdListener() {
            ...
            public void onSucc(String data, String dataEncrypt) {
                ...
                if (SwingCardOtcActivity.getReadType() == EReaderType.ICC) {
                    dialog.dismiss();
            ...
            public void onErr() {
                ...
                if (SwingCardOtcActivity.getReadType() == EReaderType.ICC) {
                    ...
                    Intent intent1 = new Intent(ConsumeOtcActivity.this, DemoActivity.class);
                    startActivity(intent1);
                }
    ...
    private void toTradeResultActivity() {
            ...
            if (promptDialog == null) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        promptDialog = new CustomAlertDialog(ConsumeOtcActivity.this, CustomAlertDialog.PROGRESS_TYPE);
        ...
        intent.putExtra("pin", getIntent().getStringExtra("pin2020"));
